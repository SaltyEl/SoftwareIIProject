...
ADDITIONAL REPORT I CHOSE TO RUN: When clicking the Scheduler button, it will show you all of the scheduled appointments.
...
filtering for week, month, contact ID, etc. The only area that is not affected by this filter is the month and type count.
